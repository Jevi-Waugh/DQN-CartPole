...
![CartPole in Action](assets/gifs/cartpole.gif)
...
- **Q-Learning**: The algorithm uses a function \( Q^*(s, a) \) to estimate the expected return of taking action \( a \) in state \( s \). The optimal policy is derived as:
